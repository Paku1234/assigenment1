...
function NavBar() {
 ...
 const words = transcript.toLowerCase().replace(/\s+/g, ' ').split(' ');

 // Check if any of the words match a command
 const command = words.find(word => ['homepage', 'salespage'].includes(word));
